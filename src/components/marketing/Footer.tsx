...
// ─── Social icons (SVG inline para zero deps) ────────────────────────────────
      ...
      <Container>
            ...
            <div className="flex items-center gap-3 mt-1">
              {SOCIALS.map(({ label, href, icon: Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex items-center justify-center size-8 rounded-lg bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary transition-colors"
                >
                  <Icon />
                </a>
              ))}
        ...
        <div className="mt-12 border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Briefr. Todos os direitos reservados.
          </p>
          <p className="text-xs text-muted-foreground">
            Feito no Brasil 🇧🇷
          </p>
